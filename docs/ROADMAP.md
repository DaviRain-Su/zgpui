...
| P2 | Stronger a11y | Labels, hierarchy, text, live, rotors, nav_order, heading/help, busy/required, AX proxy reuse, invalid, placeholder/value_description, modal dialogs, **menu/popover expanded + AXShowMenu** shipped; full VoiceOver parity still open |
