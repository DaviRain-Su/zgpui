...
| P2 | Stronger a11y | Labels, hierarchy, text, live, rotors, nav_order, heading_level, description, busy/required, AX proxy reuse, **invalid (AXInvalid + Field)** shipped; full VoiceOver parity still open |
