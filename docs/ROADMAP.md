...
| P2 | Stronger a11y | Labels, hierarchy, text, live, rotors, nav_order, heading_level, description, busy/required, **AX structural proxy reuse** shipped; full VoiceOver parity still open |
