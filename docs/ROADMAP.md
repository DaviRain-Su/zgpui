...
| P2 | Stronger a11y | Labels, hierarchy, TextArea, slider adjust, text caret/selection, AX set-value + value/selection notifications landed; selected-text range setters and rotors remain |
