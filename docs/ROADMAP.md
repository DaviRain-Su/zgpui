...
| P2 | Stronger a11y | Labels, hierarchy, text, live, rotors, nav_order, heading/help, busy/required, AX proxy reuse, invalid, **placeholder / value_description** shipped; full VoiceOver parity still open |
